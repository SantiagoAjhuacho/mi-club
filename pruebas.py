...
socio1 = Socio("Juan Pérez", datetime(1994, 5, 20), "DNI", "12345678", "Argentina",
               "01/01/2020", usuario="juanperez", contrasenia="pass123", rol="socio")
print("¿Socio1 es admin?:", socio1.es_admin())

admin1 = Socio("Ana Gómez", datetime(1985, 2, 10), "DNI", "11223344", "Argentina",
               "01/01/2018", usuario="admin", contrasenia="admin123", rol="admin")
